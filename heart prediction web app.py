...
def main():
    ...
    st.image("""https://americanaddictioncenters.org/wp-content/uploads/2018/10/the-notable-risks-of-substance-use-on-the-circulatory-system.jpg""")
    ...
    BMi = st.number_input("what is your Body Mass Index (BMI)?", min_value=0.1, max_value=100, value=1.0)
